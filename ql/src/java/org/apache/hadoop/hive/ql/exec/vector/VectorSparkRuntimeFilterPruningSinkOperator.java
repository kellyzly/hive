...
/**
 * Vectorized version for SparkRuntimeFilterPruningSinkOperator.
 **/
public class VectorSparkRuntimeFilterPruningSinkOperator extends SparkRuntimeFilterPruningSinkOperator{
  ...
  public VectorSparkRuntimeFilterPruningSinkOperator(CompilationOpContext ctx,
                                                 VectorizationContext context, OperatorDesc conf) {
    this(ctx);
    this.conf = (SparkRuntimeFilterPruningSinkDesc) conf;
    this.vContext = context;
  }

  /** Kryo ctor. */
  @VisibleForTesting
  public VectorSparkRuntimeFilterPruningSinkOperator() {
    super();
  }
