...
public class SharedTable {
  ...
  public HashMap<TableScanOperator, TableScanOperator> getSharedTables() {
    return sharedTables;
  }

  public void addSharedTable(TableScanOperator op1, TableScanOperator op2) {
    this.sharedTables.put(op1,op2);
  }
